...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post equipment_index_url, params: { equipment: { name: @equipment.name, status: @equipment.status, type: @equipment.type, user_id: @equipment.user_id } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { name: @equipment.name, status: @equipment.status, type: @equipment.type, user_id: @equipment.user_id } }
